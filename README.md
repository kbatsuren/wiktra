...
Currently, Wiktra supports 181 languages (using non-roman orthography) and its 60 different ortographies, and the following table displays their language name and corresponding 3-letter codes.
